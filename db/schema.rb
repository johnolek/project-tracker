...
ActiveRecord::Schema[8.1].define(version: 2026_07_23_161914) do
  ...
  create_table "statuses", force: :cascade do |t|
    ...
    t.integer "position", null: false
    t.datetime "updated_at", null: false
    t.index "organization_id, lower((name)::text)", name: "index_statuses_on_organization_and_lower_name", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "color_scheme", default: "southwest", null: false
    t.datetime "created_at", null: false
    t.jsonb "custom_colors"
    t.bigint "default_organization_id"
    t.string "email"
    t.datetime "email_verified_at"
    t.string "theme_mode", default: "auto", null: false
    t.datetime "updated_at", null: false
